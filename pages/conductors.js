        ...
        <div className="article">
          ...
          <div>
            ...
            <p>
              ...
              <br />
              13歳から打楽器を始める。中学校、高校で学生指揮者を務め、高校では吹奏楽コンクールでの指揮も経験した。
              <br />
              これまで、大阪大学吹奏楽団やクラリネットフェスティバル2021、Euph &
          ...
          <div>
            ...
            <p>
              ...
              <br />
              13
              歳からホルンを始める。大学から指揮を始め、これまで、大阪大学吹奏楽団、関西学生メモリアルコンサート
              2022
              等で指揮を務める。2022年9月30日にはホルン奏者として、フルート奏者の永井樹奈氏とDuo
              Recitalを企画・開催した。 <br />
              現在、Wind Ensemble 夢
              指揮者、お米企画ホルンパート。その他、北摂地域を中心に指揮者やホルンパートとして演奏会に参加している。
            </p>
          </div>
        </div>
