    ...
    <div className="container">
      ...
      <main className="main">
        <div className="article">
          ...
          <p>
            The Keynote Wind Orchestra ― 通称「ざき吹」。 楽団名には「一人ひとりが『Keynote』(大切な音)」という意味が込められています。
          ...
          <p>
            ...
            2022年の立ち上げ当初は運営スタッフの多くが4回生であり、来年度からそれぞれの道に別れて進んでいく時期に、最後の演奏会を開催したいとの思いから始まりました。 第一回演奏会の楽団メンバーの多くは大阪大学吹奏楽団の現役生、OB・OGでした。しかし、それ以外にも色々な演奏会でのつながりがあり、70人を超える奏者に集まっていただきました。
          ...
          <p>
            その後それぞれの道へ進み、一旦はばらばらになってしまいましたが、「今まで一緒に音楽をしてきた人たちとまた音楽をしたい!再集結したい」との思いから、 当初一回きりと言っていたにも関わらず、第二回演奏会を行う運びとなりました。
          </p>
          <p>
            懐かしのメンバーも、今回新たに加わるメンバーも、一人ひとりがKeynote。
            これからも、音楽を通じて出会った仲間とのつながりを大切にする楽団であり続けます。
