    ...
    <div className="container">
      ...
      <main className="main">
        <div className="article">
          ...
          {/* <p>
            本演奏会は、「ざきお」こと吉崎高士をはじめとする大阪大学吹奏楽団のOB・OGによって企画された、一度きりの演奏会です。運営スタッフの多くが4回生であり、来年度からそれぞれの道に別れて進んでいくこの時期に、最後の演奏会を開催したいとの思いから始まった。楽団メンバーの多くは大阪大学吹奏楽団の現役生、OB・OGだ。しかし、それ以外にも色々な演奏会でのつながりがあり、70人を超える奏者が集まった。
          </p>
          <p>
